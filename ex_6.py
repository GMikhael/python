...
all_days = int(input("Введите общий результат: "))
i = 1
while first_day < all_days:
    first_day = first_day * 1.1
    print(f"На {i}-й день: {first_day:.03f} км")
    i += 1
print(f"На {i}-й день спортсмен достиг результата - не менее {all_days} км.")